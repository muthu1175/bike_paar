...
from .views import AdminSendNotificationAPIView
from .views import AdminReplyFeedbackAPIView
from .views import AdminBikeAPIView
from .views import AdminBikeReviewAPIView
from .views import MaintenanceStatusAPIView, MaintenanceToggleAPIView
...
urlpatterns = [
    ...
    path('admin/notifications/send/', AdminSendNotificationAPIView.as_view(), name='admin-send-notification'),
    ...
    path('admin/toggle-maintenance/', MaintenanceToggleAPIView.as_view()),
]
